package com.yks.regit.util.ValidateImage;

import com.yks.regit.util.ValidateImage.util.GifEncoder;
import com.yks.regit.util.ValidateImage.util.Streams;

import java.awt.*;
import java.awt.image.BufferedImage;
import java.io.OutputStream;

import static com.yks.regit.util.ValidateImage.util.Randoms.alpha;
import static com.yks.regit.util.ValidateImage.util.Randoms.num;
